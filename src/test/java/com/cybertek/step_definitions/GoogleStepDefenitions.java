...
public class GoogleStepDefenitions {
    ...
    public void user_should_see_six_links_in_the_footer(List<String> linkList) {
        ...
        int expectedSize = linkList.size();
